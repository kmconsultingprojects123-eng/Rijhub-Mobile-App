...
abstract class FlutterFlowTheme {
  ...
  static FlutterFlowTheme of(BuildContext context) {
    // Start from the generated light/dark theme, then override primary and
    // onPrimary with the Material Theme's ColorScheme so both Theme.of(context)
    // and FlutterFlowTheme.of(context) stay in sync for the primary color.
    final isDark = Theme.of(context).brightness == Brightness.dark;
    final base = isDark ? DarkModeTheme() : LightModeTheme();
    try {
      final cs = Theme.of(context).colorScheme;
      // Override the primary/onPrimary so FlutterFlowTheme follows ThemeData
      base.primary = cs.primary;
      base.onPrimary = cs.onPrimary;
    } catch (_) {}
    return base;
  }
  ...
  late Color highligh1;
  late Color customColor1;

  // Color to use for text/icons placed on top of `primary` colored surfaces.
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color highlight = const Color(0x33A20025);
  late Color highligh1 = const Color(0xFFFFB5C6);
  late Color customColor1 = const Color(0x3FA20025);
  // Text/icon color that sits on top of `primary` (red) backgrounds.
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color highlight = const Color(0x1FA20025);
  // Use a toned primary-derived highlight rather than purple/blue
  late Color highligh1 = const Color(0x33A20025);
  late Color customColor1 = const Color(0xFFF298B3);
  // On-primary should remain readable on top of the primary color.
  late Color onPrimary = const Color(0xFFFFFFFF);
}
