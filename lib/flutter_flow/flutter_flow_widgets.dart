...
class _FFButtonWidgetState extends State<FFButtonWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    // Default text/icon color: if the button background is the theme primary color,
    // use the onPrimary color for contrast, otherwise use primaryText.
    final Color defaultTextColor = widget.options.textStyle?.color ??
        ((widget.options.color != null && widget.options.color == theme.primary)
            ? theme.onPrimary
            : theme.primaryText);
    ...
    ButtonStyle style = ButtonStyle(
      ...
      iconColor: WidgetStateProperty.resolveWith<Color?>((states) {
        ...
        return widget.options.iconColor ?? defaultTextColor;
      }),
    );
...
// NOTE: AppSkeleton is used from ../widgets/skeleton.dart
